...
export type { ZoomDepth, ZoomFocus, ZoomRegion, PlaybackSpeed, SpeedRegion, AnnotationType, ArrowDirection, Annotation, CursorPoint, ElementHit, ScenarioEffects, GifOptions, } from './types.js';
