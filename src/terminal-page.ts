...
function resolveTheme(theme?: TerminalTheme | string): TerminalTheme {
  if (!theme) return DEFAULT_THEME
  if (typeof theme === 'string') return TERMINAL_THEMES[theme] ?? DEFAULT_THEME
 ...
 */
export function generateTerminalHtml(options: TerminalPageOptions): string {
