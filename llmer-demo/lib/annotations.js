 ...
 */
export function generateAnnotationDrawCode(annotation, viewportWidth, viewportHeight) {
...
function generateTextCode(x, y, w, h, annotation) {
...
function generateArrowCode(x, y, w, h, arrow) {
 ...
 */
function parseSvgPathToCanvas(path, x, y, w, h) {
    const commands = [];
 ...
 */
export function getVisibleAnnotations(annotations, timeMs) {
    return annotations
 ...
 */
export function generateAnnotationsDrawCode(annotations, timeMs, viewportWidth, viewportHeight) {
